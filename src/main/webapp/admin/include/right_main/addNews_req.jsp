		...
		<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px">
			...
			<tr bgcolor="#FFFFFF">
				<td height="30" colspan="2" align="center" valign="bottom">
				    <form action="admin/action.html?action=addnews" method="post">
<table width="735" border="0" cellspacing="1" height="168" style="border-collapse: collapse">
	...
	<tr>
		...
		<% 
		out.println("<option value='0'>默认</option>");
		%>
		</select></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<strong>提示</strong>:</font> 请把上面新闻部的表单全部填写!</td>
	</tr>
</table>
