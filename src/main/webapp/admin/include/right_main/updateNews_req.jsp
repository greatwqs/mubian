...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="8" topmargin='8'>
		...
		<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px; margin-top: 8px;">
			...
			<tr bgcolor="#FFFFFF">
				<td>此产品上次修改密码的时间为:&nbsp;<%=newsBean.getUpdatetime() %></td>
			</tr>
		</table>
		<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px">
			...
			<tr bgcolor="#FFFFFF">
				<td height="30" colspan="2" align="center" valign="bottom">
				    <form action="admin/action.html?action=updatenews&id=<%=newsBean.getId() %>" method="post"  >
<table width="735" border="0" cellspacing="1" height="168" style="border-collapse: collapse">
	<tr>
		...
		<input type="text" name="title" value="<%=newsBean.getTitle() %>" size="20" style="border: 1px solid #999999; FONT-SIZE: 12pt; BACKGROUND: #ffffff; COLOR: #000000; FONT-FAMILY: verdana; 1 px: " size="20" onmouseover="this.style.backgroundColor = '#E5F0FF'" onmouseout="this.style.backgroundColor = ''" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="419" height="33" align="left">
		<input type="text" name="createTime" value="<%=newsBean.getCreatetime() %>" size="20" style="border: 1px solid #999999; FONT-SIZE: 12pt; BACKGROUND: #ffffff; COLOR: #000000; FONT-FAMILY: verdana; 1 px: " size="20" onmouseover="this.style.backgroundColor = '#E5F0FF'" onmouseout="this.style.backgroundColor = ''" disabled/></td>
	</tr>
	<tr>
		<td width="309" height="33" align="right"><font color="#0000FF"><b>介绍:
		</b></font></td>
		<td width="419" height="33" align="left">
		<textarea rows="5" name="content" cols="36" style="border: 1px solid #999999; FONT-SIZE: 12pt; BACKGROUND: #ffffff; COLOR: #000000; FONT-FAMILY: verdana; 1 px: " size="20" onmouseover="this.style.backgroundColor = '#E5F0FF'" onmouseout="this.style.backgroundColor = ''" ><%=newsBean.getContent() %></textarea>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<strong>提示</strong>:</font> 创建时间不能更改。</td>
	</tr>
</table>
